...
(AG) The variables EXNAME and INNAME were modified to be strings. Then depending on the string value the correct function name would be called. See src/Geopack-2008_dp.for.diff.
